...
class ClipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clip" do
    assert_difference('Clip.count') do
      post clips_url, params: { clip: { body: @clip.body, image: @clip.image, title: @clip.title, url: @clip.url } }
    end
  ...
  test "should update clip" do
    patch clip_url(@clip), params: { clip: { body: @clip.body, image: @clip.image, title: @clip.title, url: @clip.url } }
